...
public class CreateCollegeRecord {
	...
	public CreateCollegeRecord(String district, String collegeName, String collegeCode, String mandal, String state,
			String pocName, String pocPhone, String pocEmail, Date dateofVisit, String mouStatus,
			List<Comment> comments, Date dueDate, String createdBy, String status) {
		super();
		this.district = district;
		this.collegeName = collegeName;
		this.collegeCode = collegeCode;
